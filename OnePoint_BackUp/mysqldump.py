...
def Data_Completion(upload_path, finish_path, filename):
    ...
    shutil.move(join(upload_path, filename), join(finish_path,file_name))
    return True
...
if __name__ == '__main__':
    ...
    try:
        ...
        Data_Completion("C:\inetpub\wwwroot\OnePoint_BackUp\Data", r"O:\\", file_name)

        Email_Success(ScriptConfig)
